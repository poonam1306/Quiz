...
if(@$submit=='Finish')
{
	mysqli_query($link,"delete from useranswer where sess_id='" . session_id() ."'") or die(mysqli_error());
	unset($_SESSION['qn']);
...
$rs=mysqli_query($link,"select * from useranswer where sess_id='" . session_id() ."'") or die(mysqli_error($link));
