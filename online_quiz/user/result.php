...
extract($_SESSION);
$rs=mysqli_query($link,"select t.test_name,t.total_que,r.test_date,r.score from test t, result r where
t.test_id=r.test_id and r.username='$login'") or die(mysqli_error($link));
